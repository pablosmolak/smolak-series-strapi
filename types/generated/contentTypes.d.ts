...
export interface ApiSerieSerie extends Schema.CollectionType {
  ...
  attributes: {
    ...
    qtd_temporadas: Attribute.Integer & Attribute.Required;
    classificacao_indicativa: Attribute.Enumeration<
      [
        'Livre',
        'Dez Anos',
        'Doze Anos',
    ...
    idioma_original: Attribute.String;
